/*All rights of this program is goes to Habib Ur Rahman*/
...
// define three tasks for Sending data & ECG data collection
...
{ 
  ...
  */
  ...
  //Initalizing the tasks in the RTOS
  ...
  { 
    ...
    if(xSemaphoreTake(mutex,portMAX_DELAY) == pdTRUE)
    {
      ...
      for(int i=0 ;i<1500 ;i++)
      {
       ...
       if((ecg_array[i]<LowerThreshold)&&(BPMTiming))
        BeatComplete=true;
        }
     }
