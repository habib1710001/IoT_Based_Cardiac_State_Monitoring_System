...
<body>
    <h3 style="text-align:center; margin-left: 10%; border-radius: 0px; margin:0px;  background-color:Red; border: 2px red;border-radius: 5px; margin-left:20%; margin-right:20%; color:White;">RAW VOLTAGE DATA</h3>
	<a class="btn btn-success" href="table_voltage.php" style="border-radius: 0px; margin:0px;  background-color:Red; border: 2px red;border-radius: 10px;">Main</a>
  ...
  <tbody>
  	...
  	if ($cnt > 0) {
					while($row = $result->fetch_assoc()) {
						...
						echo "<td>" . ($row["value1"]*3)/16000 . "</td>";     //col_name
...
<?php
  ...
  ?>
  <form method="POST" action="table_voltage.php">
